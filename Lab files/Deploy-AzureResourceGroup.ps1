...
Param(
  ...
  [string] $ResourceGroupName = 'AzureResourceGroupProjects',
...
if ($UploadArtifacts)
{
	...
	$value = $ArtifactsLocation -eq $null
	write-Host "!"$ArtifactsLocation"!"
   # if ($ArtifactsLocation -eq " ")
   # {
        $ArtifactsLocation = $StorageAccountContext.BlobEndPoint + $StorageContainerName
		
        $OptionalParameters[$ArtifactsLocationName] = $ArtifactsLocation.Trim()
		$ArtifactsLocation = $ArtifactsLocation.Trim()
   # }
